...
![Version: 3.0.0](https://img.shields.io/badge/Version-3.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.0.0](https://img.shields.io/badge/AppVersion-v1.0.0-informational?style=flat-square)
...
* <https://github.com/formancehq/helm/tree/main/charts/console>
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| config.publisher.clientID | string | `"console"` | NATS client ID |
| config.publisher.topicMapping | string | `"console"` | NATS topic mapping |
