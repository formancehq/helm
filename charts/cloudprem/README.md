...
![Version: 4.10.2](https://img.shields.io/badge/Version-4.10.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| portal.config.featuresDisabled[0] | string | `"notifications"` |  |
| portal.config.featuresDisabled[1] | string | `"sessions"` |  |
