...
| ingress.tls | list | `[]` |  |
| payments.httpBindAddr | string | `"0.0.0.0:3068"` |  |
| payments.lock.connString | string | `"redis://redis:6379/0"` |  |
| payments.lock.strategy | string | `"redis"` |  |
| payments.lock.tls | bool | `false` |  |
| payments.login | string | `"payments:payments"` |  |
| payments.storage.connString | string | `"postgresql://payments:payments@postgres/payments"` |  |
| payments.storage.driver | string | `"postgres"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
