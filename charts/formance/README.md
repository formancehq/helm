...
![Version: 1.14.4](https://img.shields.io/badge/Version-1.14.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| regions.versions.files."v3.2".payments | string | `"v3.3.2"` |  |
...
| regions.versions.files."v3.2".webhooks | string | `"v2.4.1"` |  |
