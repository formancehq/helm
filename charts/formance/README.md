...
| regions.versions.files."v3.0".reconciliation | string | `"v2.3.0"` |  |
...
| regions.versions.files."v3.1".reconciliation | string | `"v2.3.0"` |  |
...
| regions.versions.files."v3.2".reconciliation | string | `"v2.3.0"` |  |
