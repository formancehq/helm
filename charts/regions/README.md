...
![Version: 2.21.0](https://img.shields.io/badge/Version-2.21.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| versions.files."v2.0".auth | string | `"v2.2.0"` |  |
...
| versions.files."v2.1".auth | string | `"v2.2.0"` |  |
...
| versions.files."v2.2".auth | string | `"v2.2.0"` |  |
...
| versions.files."v3.0".auth | string | `"v2.2.0"` |  |
