...
![Version: 2.15.13](https://img.shields.io/badge/Version-2.15.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| oci://ghcr.io/formancehq/helm | operator | v2.10.7 |
...
| versions.files."v2.0".payments | string | `"v2.0.27"` |  |
...
| versions.files."v2.2".ledger | string | `"v2.2.21"` |  |
