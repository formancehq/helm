...
![Version: 2.17.15](https://img.shields.io/badge/Version-2.17.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| versions.files."v2.0".payments | string | `"v2.0.30"` |  |
...
| versions.files."v2.1".payments | string | `"v2.0.30"` |  |
...
| versions.files."v3.0".ledger | string | `"v2.2.41"` |  |
