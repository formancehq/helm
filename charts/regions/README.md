...
![Version: 3.10.6](https://img.shields.io/badge/Version-3.10.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| versions.files."v2.0".gateway | string | `"v2.2.0"` |  |
...
| versions.files."v2.1".gateway | string | `"v2.2.0"` |  |
...
| versions.files."v2.1".webhooks | string | `"v2.4.0"` |  |
...
| versions.files."v2.2".webhooks | string | `"v2.4.0"` |  |
...
| versions.files."v3.0".webhooks | string | `"v2.4.0"` |  |
...
| versions.files."v3.1".webhooks | string | `"v2.4.0"` |  |
...
| versions.files."v3.2".webhooks | string | `"v2.4.0"` |  |
